    ...
    <div className='priP'>
        <div className='privacyHousing'>
            ...
            <div>
                ...
                <div className=' mkil'> <span className='lion'>b.</span> <p className='toPros'><span className="change"> Development Phase (once work has started): </span>If cancellation is requested during the development phase, Adane Technology will charge for the work completed based on milestones or the percentage of the project already delivered. Any unused portion of the client’s payment will be refunded.</p></div>
                ...
                <div className=' mkil'> <span className='lion'>b.</span> <p className='toPros'>The client violates any of the terms and conditions agreed upon at the start of the project.</p></div>
              
                </div>
                <p className='WeUe'>In the event of such cancellations, Adane Technology will provide a refund proportional to the work completed or offer alternative solutions.</p>
            </div>
             <div>
             ...
             <div>
              ...
              <div>
                                ...
                                <p className='InfoCollect'> <span>4. </span> Dispute Resolution</p>
                               
                                       <p className='WeUe'>Adane Technology is committed to resolving any disputes amicably and professionally. If the client is unsatisfied with any aspect of our services, we encourage open communication to address concerns. If an agreement cannot be reached, both parties may seek mediation or legal arbitration as a final resort.</p>
              
                     
            </div>
            <div>
                 <p className='InfoCollect'> <span>5. </span> Exclusions</p>
                 
                                       <p className='WeUe'>This Refund and Cancellation Policy does not apply to:</p>
                <div className='DivGu'>
                <div className='toPros mkil'> <span className='lion'>a.</span>  <p className='toPros'>Third-party software, services, or licenses purchased on behalf of the client.</p></div>
                <div className=' mkil'> <span className='lion'>b.</span> <p className='toPros'>Delays caused by client-side inaction, lack of communication, or failure to provide necessary project resources.</p></div>
...
export default withTitle(Refund, 'Refund and Cancellation Policy of - Adane Technology');